    ...
    render(){
        return (
            <Container>
                ...
                <LongCard isImageOnLeft={false} image={'https://via.placeholder.com/200'} title={'Noodle Demention'}>
                    Sometimes I just need to go to my happy place. With this Noodle Dimention, and the power of Virtual Reality, 
                    I was able to will this dream land into reality. This project is my piece of a inter-dimentional showroom. 
                ...
                <LongCard isImageOnLeft={true} image={'https://via.placeholder.com/200'} title={'Developed and Released Mobile Apps'}>
                    ...
                    There can be a some back and forth and things can go wrong but all in all it's a great learning experience.
                </LongCard>
                <LongCard isImageOnLeft={false} image={'https://via.placeholder.com/200'} title={'AR Adventures'}>
                    ...
                    Ground-breaking hardware, like the Microsoft Hololens. I also created AR product visualing apps
                    for tablets and phones. I am exited to see how Augmented Reality takes off in the future. 
                </LongCard>
                <LongCard isImageOnLeft={true} image={'https://via.placeholder.com/200'} title={'Emotes with Emotion'}>
                    ...
                    <a href="https://www.twitch.tv/slyraider" target="_blank" rel="noopener noreferrer"> Here</a>. 
                ...
                <LongCard isImageOnLeft={false} image={'https://via.placeholder.com/200'} title={'Concert Visuals'}>
                    The fine folks in Lilac Cruise, a local band, asked my to create Visuals for their upcomming concerts.
                    Because they are not going to be playing very may shows in 2020, They wanted the shows they do play to 
